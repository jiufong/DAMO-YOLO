...
class Config(MyConfig):
    def __init__(self):
        ...
        self.train.finetune_path = os.environ["FINE_TUNE_PATH"]
        self.miscs.exp_name = os.path.split(
            os.path.realpath(__file__))[1].split('.')[0]
        self.miscs.eval_interval_epochs = 3
        self.miscs.ckpt_interval_epochs = 10
        # optimizer
        self.train.batch_size = int(os.environ["BATCH_SIZE"])
        self.train.base_lr_per_img = float(os.environ["LEARNING_RATE"]) / 64
        ...
        self.train.total_epochs = int(os.environ["TOTAL_EPOCHS"])
        ...
        self.dataset.val_ann = ('valid_coco', )
        self.dataset.test_ann = ('test_coco', )
        ...
        self.dataset.class_names = os.environ["CLASS_NAMES"].split(",")